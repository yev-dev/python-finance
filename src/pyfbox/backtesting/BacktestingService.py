...
from pyfbox.backtesting import Position as pos
from pyfbox.backtesting import MarketData as md
from pyfbox.backtesting import Strategy as str
...
class Backtester:
    ...
    def start_backtest(self):
        self.strategy = str.MeanRevertingStrategy(self.target_symbol)
        self.strategy.event_sendorder = self.evthandler_order

        mds = md.MarketDataSource()
